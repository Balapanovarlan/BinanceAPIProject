  ...
  return (
    <div className={styles.container}> 
        ...
        <div className={styles.change}>
            <span className={styles.changeValue}>{Number(priceChange).toFixed(3)}</span>
            <StepBackIcon className={cn(styles.changeIcon,Number(priceChange)>0 ?  styles.up : styles.down)} />
        </div>
